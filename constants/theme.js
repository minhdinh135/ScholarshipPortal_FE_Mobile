...
export const FONTS = {
    ...
    h2: { fontFamily: require("../assets/fonts/Roboto-Bold.ttf"), fontSize: SIZES.h2, lineHeight: 30 },
    h3: { fontFamily: require("../assets/fonts/Roboto-Bold.ttf"), fontSize: SIZES.h3, lineHeight: 22 },
    h4: { fontFamily: require("../assets/fonts/Roboto-Bold.ttf"), fontSize: SIZES.h4, lineHeight: 22 },
    h5: { fontFamily: require("../assets/fonts/Roboto-Bold.ttf"), fontSize: SIZES.h5, lineHeight: 22 },
